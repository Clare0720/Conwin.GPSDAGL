define(['/Modules/Config/conwin.main.js'], function () {
    require(['jquery', 'helper', 'tipdialog', 'system', 'toast', 'cokie', 'crypto', 'uniform'], function ($, helper, tipdialog, system, Toastr) {
                        ...
                        if (result.publicresponse.statuscode == 0) {
                            helper.AdaptLogin(result.body, function () {
                                ...
                                helper.UserInfo(function (userInfo) {
                                    ...
                                    if (userInfo.body.OrganizationType == 2 /*&& userInfo.OrganCity == '广州'*/) {
                                        helper.Ajax("006600200067", userInfo.body.OrganizationCode, function (result) {
                                            if (result.publicresponse.statuscode == 0) {
                                                var status = result.body;
                                                if (status != 1) {
                                                    window.location.href = "/Modules/GPSDAGL/QiYeXinXi/ConfirmBaseInfo.html"
                                                }
                                                else {
                                                    ...
                                                    if (returnurl) {
                                                        ...
                                                        } else if (this.location.href.toUpperCase().indexOf('GpsHaLogin.html'.toUpperCase()) > 0) {
        ...
        var setTheamCookie = function (token, strHref) {
            ...
            } else if (strHref.indexOf('GpsLTLogin.html'.toUpperCase()) > 0) {
                $.cookie(token + 'Theam', '/Modules/Component/Theme/Theme3/Css/base.css', {
                    path: "/"
                });
            }
