...
CMSDemuxer.prototype._parseScriptData = function () {
    ...
    this._mediaInfo.hasAudio          = this._hasAudio;
    this._hasVideo                    = this.cms.header.hasVideo;
    this._mediaInfo.hasVideo          = this._hasVideo;
    ...
    if (this._hasVideo) {
        ...
        this._mediaInfo.width             = this.cms.header.videoTrack.width;
        this._mediaInfo.height            = this.cms.header.videoTrack.height;;
...
CMSDemuxer.prototype._parseAudioData = function (part) {
    ...
    if (!meta) {
        ...
        meta.duration = this._duration / this._timescale;
        meta.channelCount = 1;
    }
