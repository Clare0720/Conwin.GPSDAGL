        ...
        function ($, popdialog, tipdialog, toast, helper, common, tableheadfix, system) {
                ...
                $('#btnDel').on('click', function (e) {
                    ...
                    checkPower(function () {
                        ...
                        tipdialog.confirm("确定要删除选中的记录？", function (r) {
                            if (r) {
                                //TODO:调作废接口
                                helper.Ajax("003300300321", ids, function (data) {
                                    if ($.type(data) == "string") {
                ...
                $('#btnCancel').on('click', function (e) {
                    ...
                    checkPower(function () {
                        ...
                        tipdialog.confirm("确定要停用选中的记录？", function (r) {
                            if (r) {
                                //TODO:调作废接口
                                helper.Ajax("003300300323", ids, function (data) {
                                    if ($.type(data) == "string") {
                                        data = helper.StrToJson(data);
                                    }
                                    if (data.publicresponse.statuscode == 0) {
                ...
                $('#btnUse').on('click', function (e) {
                    ...
                    checkPower(function () {
                        ...
                        tipdialog.confirm("确定要启用选中的记录？", function (r) {
                            if (r) {
                                //TODO:调作废接口
                                helper.Ajax("003300300322", ids, function (data) {
                                    if ($.type(data) == "string") {
                                        data = helper.StrToJson(data);
                                    }
                                    if (data.publicresponse.statuscode == 0) {
            ...
            function initlizableTable() {
                $("#tb_Template").CustomTable({
                    ajax: helper.AjaxData("003300300317",
                        function (data) {
