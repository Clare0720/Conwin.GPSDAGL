define(['/Modules/Config/conwin.main.js'], function () {
    require(['jquery', 'popdialog', 'tipdialog', 'toast', 'helper', 'common', 'formcontrol', 'prevNextpage', 'tableheadfix', 'system', 'selectcity', 'filelist', 'fileupload', 'selectCity2', 'dropdown', 'metronic', 'customtable', 'bootstrap-datepicker.zh-CN', 'bootstrap-datetimepicker.zh-CN'],
        function ($, popdialog, tipdialog, toast, helper, common, formcontrol, prevNextpage, tableheadfix, system, selectcity, filelist, fileupload, selectCity2, dropdown) {
            //模块初始化
            ...
            var initPage = function () {
               ...
               common.AutoFormScrollHeight('#LianXiXinXi', function (hg) {
                ...
                $('#saveBtn').on('click', function (e) {
                    ...
                    if ($.trim(fromData.PingTaiBianHao) == '') {
                        msg += "平台编号 是必填项<br/>";
                    }
                    if ($.trim(fromData.PingTaiGuoJianPiCi) == '') {
                        msg += "过检批次 是必填项<br/>";
                    }
            ...
            function save() {
                ...
                //调用修改接口
                helper.Ajax("003300300506", jsonData1, function (data) {
                    if ($.type(data) == "string") {
