    ...
    require(['jquery', 'popdialog', 'tipdialog', 'toast', 'helper', 'common', 'formcontrol', 'prevNextpage', 'tableheadfix', 'system', 'selectcity', 'filelist', 'metronic', 'customtable', 'bootstrap-datepicker.zh-CN', 'bootstrap-datetimepicker.zh-CN'],
        function ($, popdialog, tipdialog, toast, helper, common, formcontrol, prevNextpage, tableheadfix, system, selectcity, filelist, Metronic) {
            ...
            function fillFormData(resource) {
                $('#Form1').find('input[name],select[name],textarea[name]').each(function (i, item) {
                    ...
                    if (tempValue != undefined) {
                        ...
                        if ($(item).attr('name') == 'ShouFeiJinE') {
                            $("#HiddenShouFeiJinE").val(tempValue);
                            tempValue = Math.round(tempValue * 100) / 100;
                        }
                        if ($(item).attr('name') == 'ShiShouJinE') {
                            $("#HiddenShiShouJinE").val(tempValue);
                            tempValue = Math.round(tempValue * 100) / 100;
                        }
                        if ($(item).attr('name') == 'HuiKuanJinE') {
                            $("#HiddenHuiKuanJinE").val(tempValue);
                            tempValue = Math.round(tempValue * 100) / 100;
                        }
                        //TODO: 赋值
            ...
            function save() {
                ...
                if(jsonData1.ShouFeiJinE == Math.round($("#HiddenShouFeiJinE").val() * 100) / 100){
                    jsonData1.ShouFeiJinE = $("#HiddenShouFeiJinE").val();
                }
                if(jsonData1.ShiShouJinE == Math.round($("#HiddenShiShouJinE").val() * 100) / 100){
                    jsonData1.ShiShouJinE = $("#HiddenShiShouJinE").val();
                }
                if(jsonData1.HuiKuanJinE == Math.round($("#HiddenHuiKuanJinE").val() * 100) / 100){
                    jsonData1.HuiKuanJinE = $("#HiddenHuiKuanJinE").val();
                }
                //调用修改接口
