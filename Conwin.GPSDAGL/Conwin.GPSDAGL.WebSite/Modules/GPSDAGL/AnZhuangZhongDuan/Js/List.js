        ...
        function ($, popdialog, tipdialog, toast, helper, common, tableheadfix, system, selectcity) {
            var initPage = function () {
                ...
                $('#btnView').on('click', function (e) {
                    ...
                    var viewType = "ViewGPS.html";
                    if (rows[0].data.ZhongDuanLeiXing == 5) {
                        viewType = "ViewVideo.html";
                    }
                    popdialog.showIframe({
                        'url': viewType,
                        head: false
            ...
            function initlizableTable() {
                $("#tb_Template").CustomTable({
                    ajax: helper.AjaxData("003300300529",///"00020003"为接口服务地址，需要在/Config/conwin.system.js中配置
                        function (data) {
                    ...
                    columns: [
                        ...
                        { data: 'SheBeiXingHao' },
                        {
                            ...
                            render: function (data, type, row, meta) {
                                return converZhongDuanLeiXin(data);
                            }
                        },
                        { data: 'DaiLiShangOrgName' },
                        { data: 'FuWushangOrgName' },
                        {
                            data: 'AnZhuangZhuangTai',
                            render: function (data, type, row, meta) {
                                return data ? (data==1?"已安装":"未安装"):""
                            }
                        },
                        {
                            data: 'FuWuKaiShiShiJian',
                            render: function (data, type, row, meta) {
                                return data ? data.substring(0,10):"";
                            }
                        },
                        {
                            data: 'FuWuJieShuShiJian',
                            render: function (data, type, row, meta) {
                                return data ? data.substring(0, 10) : "";
                            }
                        }
            ...
            function converZhongDuanLeiXin(ZhongDuanLeiXing) {
                var str = "";
                switch (ZhongDuanLeiXing) {
                    case 1:
                        str = "部标"
                        break;
                    case 2:
