...
public partial class FuWuShangCheLiangGPSZhongDuanShuJuTongXunPeiZhiXinXiMap :  BaseMap<FuWuShangCheLiangGPSZhongDuanShuJuTongXunPeiZhiXinXi>
    {
        public FuWuShangCheLiangGPSZhongDuanShuJuTongXunPeiZhiXinXiMap()
        {
			...
			this.Map(m =>
			{
				...
				m.ToTable("T_FuWuShangCheLiangGPSZhongDuanShuJuTongXunPeiZhiXinXi");
			});
