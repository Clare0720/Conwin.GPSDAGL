...
public partial class CheLiangGPSZhongDuanXinXiMap :  BaseMap<CheLiangGPSZhongDuanXinXi>
    {
        public CheLiangGPSZhongDuanXinXiMap()
        {
			...
			this.Map(m =>
			{
				...
				m.ToTable("T_CheLiangGPSZhongDuanXinXi");
			});
