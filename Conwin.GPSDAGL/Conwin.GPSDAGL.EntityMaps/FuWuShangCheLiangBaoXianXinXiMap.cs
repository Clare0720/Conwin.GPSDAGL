...
public partial class FuWuShangCheLiangBaoXianXinXiMap :  BaseMap<FuWuShangCheLiangBaoXianXinXi>
    {
        public FuWuShangCheLiangBaoXianXinXiMap()
        {
			...
			this.Map(m =>
			{
				...
				m.ToTable("T_FuWuShangCheLiangBaoXianXinXi");
			});
