...
public partial class FuWuShangZhongDuanFileMapperMap :  BaseMap<FuWuShangZhongDuanFileMapper>
    {
        public FuWuShangZhongDuanFileMapperMap()
        {
			...
			this.Map(m =>
			{
				...
				m.ToTable("T_FuWuShangZhongDuanFileMapper");
			});
            ...
            this.Property(t => t.FuWuShangZhongDuanId).HasColumnName("FuWuShangZhongDuanId");
