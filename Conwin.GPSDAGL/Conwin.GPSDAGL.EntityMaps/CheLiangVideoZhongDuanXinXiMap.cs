...
public partial class CheLiangVideoZhongDuanXinXiMap :  BaseMap<CheLiangVideoZhongDuanXinXi>
    {
        public CheLiangVideoZhongDuanXinXiMap()
        {
			...
			this.Map(m =>
			{
				...
				m.ToTable("T_CheLiangVideoZhongDuanXinXi");
			});
