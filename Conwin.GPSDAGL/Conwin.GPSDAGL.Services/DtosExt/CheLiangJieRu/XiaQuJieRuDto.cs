...
namespace Conwin.GPSDAGL.Services.DtosExt.CheLiangJieRu
{
    ...
    /// 列表查询请求
    /// </summary>
    public class XiaQuJieRuRequestDto
    {
        /// <summary>
        /// 辖区市
        /// </summary>
    ...
    public class QueryXiaQuJieRuDto
    {
    ...
    /// 列表查询响应
    /// </summary>
    public class XiqQuJieRuResponseDto
    {
        /// <summary>
        /// 辖区市
        /// </summary>
    ...
    public class GetXiaQuJieRuXinXiDto
    {
        public int Count { get; set; }

        public List<XiqQuJieRuResponseDto> list { get; set; }
    }
